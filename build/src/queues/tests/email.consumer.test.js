...
jest.mock('amqplib');
jest.mock('@chandrashekar2001/ecommerce-shared');
describe('Email Consumer', () => {
    ...
    describe('consumeAuthEmailMessages method', () => {
        it('should be called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(connectionChannel.assertExchange).toHaveBeenCalledWith('ecommerce-email-notification', 'direct');
            expect(connectionChannel.assertQueue).toHaveBeenCalledTimes(1);
            expect(connectionChannel.consume).toHaveBeenCalledTimes(1);
            expect(connectionChannel.bindQueue).toHaveBeenCalledWith('auth-email-queue', 'ecommerce-email-notification', 'auth-email');
        }));
    });
