...
import { winstonLogger, IEmailLocals } from '@chandrashekar2001/ecommerce-shared';
...
async function consumeAuthEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    const ecommerceQueue = await channel.assertQueue(queueName, { durable: true, autoDelete: false });
